...
<figcaption>Present ($z_i = 1$), but not detected ($y_{ij} = 0$). <it>Photo by Caroline Kirk (<a href = "https://www.independent.co.uk/news/uk/wildlife-photographer-owl-camera-image-b1818585.html"> source</a>)</it></figcaption>
...
#| fig-cap: "True and inferred occupancy parameters with unmarked"
...
post_folder <- here("content", "posts", "occupancy")
...
#| dev: svg
#| dev.args: !expr list(bg="transparent")
#| fig-cap: "True and inferred occupancy parameters with Stan"
