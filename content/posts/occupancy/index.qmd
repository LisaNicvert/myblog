...
![Present ($z_i = 1$), but not detected ($y_{ij} = 0$). _Photo by Caroline Kirk ([source](https://www.independent.co.uk/news/uk/wildlife-photographer-owl-camera-image-b1818585.html))_](images/occupancy/bird.png)
